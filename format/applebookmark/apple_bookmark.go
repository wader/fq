...
func decodeResourcePropertyFlags(d *decode.D) {
	start := d.Pos()
	d.FieldStruct("property_flags", decodeTgtPropertyFlagBits)
	d.FieldRawLen("unused_property_bits", 64-(d.Pos()-start))

	start = d.Pos()
	d.FieldStruct("enabled_property_flags", decodeTgtPropertyFlagBits)
	d.FieldRawLen("unused_indicator_bits", 64-(d.Pos()-start))
}
...
func decodeVolumePropertyFlags(d *decode.D) {
	start := d.Pos()
	d.FieldStruct("property_flags", decodeVolPropertyFlagBits)
	d.FieldRawLen("unused_property_bits", 64-(d.Pos()-start))

	start = d.Pos()
	d.FieldStruct("enabled_property_flags", decodeVolPropertyFlagBits)
	d.FieldRawLen("unused_indicator_bits", 64-(d.Pos()-start))
}
