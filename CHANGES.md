...
- Update gojq fork. Changes from upstrea:
  - Reduced memory usage for long running scriptsa (restore data offset when popping fork)
  ...
  - Icrease the array index limit to 2^29
