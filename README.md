...
|`mp4`                |MPEG-4&nbsp;file                                              |<sub>`av1_ccr`, `av1_frame`, `flac_frame`, `flac_metadatablock`, `mp3_frame`, `aac_frame`, `avc_dcr`, `avc_au`, `mpeg_es`, `hevc_dcr`, `hevc_au`, `mpeg_pes_packet`, `opus_packet`, `vorbis_packet`, `vp9_frame`, `vpx_ccr`, `id3_v2`, `protobuf_widevine`</sub>|
