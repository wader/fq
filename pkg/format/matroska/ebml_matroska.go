...
import "fq/pkg/format/matroska/ebml"
...
var matroskaSegment = ebml.Tag{
	...
	TagsID: {
		...
		Type:       ebml.Master, Tag: matroskaTags,
	},
}

var matroskaSeekHead = ebml.Tag{
	SeekID: {
		Name:       "Seek",
		Definition: "Contains a single seek entry to an EBML Element.",
		Type:       ebml.Master, Tag: matroskaSeek,
	},
}

var matroskaSeek = ebml.Tag{
	SeekIDID: {
		Name:       "SeekID",
...
var matroskaInfo = ebml.Tag{
	...
	ChapterTranslateID: {
		...
		Type:       ebml.Master, Tag: matroskaChapterTranslate,
	},
	TimestampScaleID: {
		Name:       "TimestampScale",
...
var matroskaChapterTranslate = ebml.Tag{
...
var matroskaCluster = ebml.Tag{
	...
	SilentTracksID: {
		...
		Type:       ebml.Master, Tag: matroskaSilentTracks,
	},
	PositionID: {
		Name:       "Position",
	...
	BlockGroupID: {
		...
		Type:       ebml.Master, Tag: matroskaBlockGroup,
	},
	EncryptedBlockID: {
		Name:       "EncryptedBlock",
...
var matroskaSilentTracks = ebml.Tag{
	SilentTrackNumberID: {
...
var matroskaBlockGroup = ebml.Tag{
	BlockID: {
		Name:       "Block",
	...
	BlockAdditionsID: {
		...
		Type:       ebml.Master, Tag: matroskaBlockAdditions,
	},
	BlockDurationID: {
		Name:       "BlockDuration",
	...
	SlicesID: {
		...
		Type:       ebml.Master, Tag: matroskaSlices,
	},
	ReferenceFrameID: {
		Name:       "ReferenceFrame",
		Definition: "",
		Type:       ebml.Master, Tag: matroskaReferenceFrame,
	},
}

var matroskaBlockAdditions = ebml.Tag{
	BlockMoreID: {
		Name:       "BlockMore",
		Definition: "Contain the BlockAdditional and some parameters.",
		Type:       ebml.Master, Tag: matroskaBlockMore,
	},
}

var matroskaBlockMore = ebml.Tag{
	BlockAddIDID: {
		Name:       "BlockAddID",
...
var matroskaSlices = ebml.Tag{
	TimeSliceID: {
		...
		Type:       ebml.Master, Tag: matroskaTimeSlice,
	},
}

var matroskaTimeSlice = ebml.Tag{
	LaceNumberID: {
		Name:       "LaceNumber",
...
var matroskaReferenceFrame = ebml.Tag{
	ReferenceOffsetID: {
...
var matroskaTracks = ebml.Tag{
	TrackEntryID: {
		Name:       "TrackEntry",
		Definition: "Describes a track with all Elements.",
		Type:       ebml.Master, Tag: matroskaTrackEntry,
	},
}

var matroskaTrackEntry = ebml.Tag{
	TrackNumberID: {
		Name:       "TrackNumber",
	...
	BlockAdditionMappingID: {
		...
		Type:       ebml.Master, Tag: matroskaBlockAdditionMapping,
	},
	NameID: {
		Name:       "Name",
	...
	ContentEncodingsID: {
		...
		Type:       ebml.Master, Tag: matroskaContentEncodings,
	},
}

var matroskaBlockAdditionMapping = ebml.Tag{
	BlockAddIDValueID: {
...
var matroskaTrackTranslate = ebml.Tag{
...
var matroskaVideo = ebml.Tag{
	...
	ColourID: {
		...
		Type:       ebml.Master, Tag: matroskaColour,
	},
	ProjectionID: {
		Name:       "Projection",
		Definition: "Describes the video projection details. Used to render spherical and VR videos.",
		Type:       ebml.Master, Tag: matroskaProjection,
	},
}

var matroskaColour = ebml.Tag{
	...
	MasteringMetadataID: {
		...
		Type:       ebml.Master, Tag: matroskaMasteringMetadata,
	},
}

var matroskaMasteringMetadata = ebml.Tag{
...
var matroskaProjection = ebml.Tag{
	ProjectionTypeID: {
		Name:       "ProjectionType",
...
var matroskaTrackOperation = ebml.Tag{
	TrackCombinePlanesID: {
		...
		Type:       ebml.Master, Tag: matroskaTrackCombinePlanes,
	},
	TrackJoinBlocksID: {
		Name:       "TrackJoinBlocks",
		Definition: "Contains the list of all tracks whose Blocks need to be combined to create this virtual track",
		Type:       ebml.Master, Tag: matroskaTrackJoinBlocks,
	},
}

var matroskaTrackCombinePlanes = ebml.Tag{
	TrackPlaneID: {
		Name:       "TrackPlane",
		Definition: "Contains a video plane track that need to be combined to create this 3D track",
		Type:       ebml.Master, Tag: matroskaTrackPlane,
	},
}

var matroskaTrackPlane = ebml.Tag{
	TrackPlaneUIDID: {
		Name:       "TrackPlaneUID",
...
var matroskaTrackJoinBlocks = ebml.Tag{
	TrackJoinUIDID: {
		Name:       "TrackJoinUID",
...
var matroskaContentEncodings = ebml.Tag{
	ContentEncodingID: {
		Name:       "ContentEncoding",
		Definition: "Settings for one content encoding like compression or encryption.",
		Type:       ebml.Master, Tag: matroskaContentEncoding,
	},
}

var matroskaContentEncoding = ebml.Tag{
	...
	ContentCompressionID: {
		...
		Type:       ebml.Master, Tag: matroskaContentCompression,
	},
	ContentEncryptionID: {
		...
		Type:       ebml.Master, Tag: matroskaContentEncryption,
	},
}

var matroskaContentCompression = ebml.Tag{
	ContentCompAlgoID: {
...
var matroskaContentEncryption = ebml.Tag{
	ContentEncAlgoID: {
		Name:       "ContentEncAlgo",
	...
	ContentEncAESSettingsID: {
		...
		Type:       ebml.Master, Tag: matroskaContentEncAESSettings,
	},
	ContentSignatureID: {
...
var matroskaContentEncAESSettings = ebml.Tag{
...
var matroskaCues = ebml.Tag{
	CuePointID: {
		Name:       "CuePoint",
		Definition: "Contains all information relative to a seek point in the Segment.",
		Type:       ebml.Master, Tag: matroskaCuePoint,
	},
}

var matroskaCuePoint = ebml.Tag{
	CueTimeID: {
		Name:       "CueTime",
	...
	CueTrackPositionsID: {
		...
		Type:       ebml.Master, Tag: matroskaCueTrackPositions,
	},
}

var matroskaCueTrackPositions = ebml.Tag{
	CueTrackID: {
		Name:       "CueTrack",
	...
	CueReferenceID: {
		...
		Type:       ebml.Master, Tag: matroskaCueReference,
	},
}

var matroskaCueReference = ebml.Tag{
	CueRefTimeID: {
		Name:       "CueRefTime",
...
var matroskaAttachments = ebml.Tag{
	AttachedFileID: {
		Name:       "AttachedFile",
		Definition: "An attached file.",
		Type:       ebml.Master, Tag: matroskaAttachedFile,
	},
}

var matroskaAttachedFile = ebml.Tag{
	FileDescriptionID: {
...
var matroskaChapters = ebml.Tag{
	EditionEntryID: {
		Name:       "EditionEntry",
		Definition: "Contains all information about a Segment edition.",
		Type:       ebml.Master, Tag: matroskaEditionEntry,
	},
}

var matroskaEditionEntry = ebml.Tag{
	EditionUIDID: {
		Name:       "EditionUID",
	...
	ChapterAtomID: {
		...
		Type:       ebml.Master, Tag: matroskaChapterAtom,
	},
}

var matroskaChapterAtom = ebml.Tag{
	ChapterUIDID: {
		Name:       "ChapterUID",
	...
	ChapterTrackID: {
		...
		Type:       ebml.Master, Tag: matroskaChapterTrack,
	},
	ChapterDisplayID: {
		Name:       "ChapterDisplay",
		Definition: "Contains all possible strings to use for the chapter display.",
		Type:       ebml.Master, Tag: matroskaChapterDisplay,
	},
	ChapProcessID: {
		Name:       "ChapProcess",
		Definition: "Contains all the commands associated to the Atom.",
		Type:       ebml.Master, Tag: matroskaChapProcess,
	},
}

var matroskaChapterTrack = ebml.Tag{
	ChapterTrackUIDID: {
...
var matroskaChapterDisplay = ebml.Tag{
	ChapStringID: {
		Name:       "ChapString",
...
var matroskaChapProcess = ebml.Tag{
	...
	ChapProcessCommandID: {
		...
		Definition: "Contains all the commands associated to the Atom.",
		Type:       ebml.Master, Tag: matroskaChapProcessCommand,
	},
}

var matroskaChapProcessCommand = ebml.Tag{
	ChapProcessTimeID: {
...
var matroskaTags = ebml.Tag{
	TagID: {
		Name:       "Tag",
		Definition: "A single metadata descriptor.",
		Type:       ebml.Master, Tag: matroskaTag,
	},
}

var matroskaTag = ebml.Tag{
	TargetsID: {
		Name:       "Targets",
		...
		Type:       ebml.Master, Tag: matroskaTargets,
	},
	SimpleTagID: {
		Name:       "SimpleTag",
		Definition: "Contains general information about the target.",
		Type:       ebml.Master, Tag: matroskaSimpleTag,
	},
}

var matroskaTargets = ebml.Tag{
	TargetTypeValueID: {
...
var matroskaSimpleTag = ebml.Tag{
	TagNameID: {
		Name:       "TagName",
